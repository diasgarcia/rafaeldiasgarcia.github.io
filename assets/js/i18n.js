...
const translations = {
    'pt-BR': {
        ...
        'experience.cwi.position': 'Estagiário de engenharia de software',
        'experience.cwi.description': 'Atuo como Software Development Intern na CWI Software, com foco em QA, automação de testes e desenvolvimento backend. Minha atuação envolve testes automatizados com Playwright, desenvolvimento com Spring Boot e banco de dados PostgreSQL, sempre com foco em qualidade, organização e melhoria contínua.',
    ...
    'en': {
        ...
        'about.p1': 'I am a Software Engineering student and Software Development Intern focused on QA, test automation, and backend development. I completed Level 2 of CWI Crescer, where I deepened my foundation in development, testing, and software quality best practices. Currently, I am directing my studies and projects toward Spring, Playwright, and PostgreSQL.',
        ...
        'experience.cwi.company': 'CWI Software',
        'experience.cwi.position': 'Software Engineering Intern',
        'experience.cwi.description': 'I work as a Software Development Intern at CWI Software, focusing on QA, test automation, and backend development. My work includes automated testing with Playwright, development with Spring Boot, and PostgreSQL databases, always focused on quality, organization, and continuous improvement.',
    ...
    'es': {
        ...
        'about.p1': 'Soy estudiante de Ingeniería de Software y Software Development Intern, con foco en QA, automatización de pruebas y backend. Completé el Level 2 de CWI Crescer, donde profundicé mi base en desarrollo, pruebas y buenas prácticas de calidad de software. Actualmente, dirijo mis estudios y proyectos hacia Spring, Playwright y PostgreSQL.',
        ...
        'experience.cwi.company': 'CWI Software',
        'experience.cwi.position': 'Practicante de ingeniería de software',
        'experience.cwi.description': 'Trabajo como Software Development Intern en CWI Software, con foco en QA, automatización de pruebas y desarrollo backend. Mi trabajo incluye pruebas automatizadas con Playwright, desarrollo con Spring Boot y bases de datos PostgreSQL, siempre con foco en calidad, organización y mejora continua.',
    ...
    'zh': {
        ...
        // About Section
        'about.title': '关于我',
        'about.p1': '我是软件工程学生，也是软件开发实习生，专注于 QA、测试自动化和后端开发。我完成了 CWI Crescer Level 2，在那里加深了自己在开发、测试和软件质量最佳实践方面的基础。目前，我正将学习和项目重点放在 Spring、Playwright 和 PostgreSQL 上。',
        ...
        'experience.cwi.company': 'CWI Software',
        'experience.cwi.position': '软件工程实习生',
        'experience.cwi.description': '我在 CWI Software 担任软件开发实习生，专注于 QA、测试自动化和后端开发。我的工作包括使用 Playwright 进行自动化测试、使用 Spring Boot 开发，以及处理 PostgreSQL 数据库，始终关注质量、组织性和持续改进。',
    ...
    'de': {
        ...
        'about.p1': 'Ich bin Software-Engineering-Student und Software Development Intern mit Fokus auf QA, Testautomatisierung und Backend-Entwicklung. Ich habe Level 2 des CWI Crescer abgeschlossen, wo ich meine Grundlagen in Entwicklung, Tests und Best Practices für Softwarequalität vertieft habe. Derzeit richte ich meine Studien und Projekte auf Spring, Playwright und PostgreSQL aus.',
        ...
        'experience.cwi.company': 'CWI Software',
        'experience.cwi.position': 'Praktikant im Software-Engineering',
        'experience.cwi.description': 'Ich arbeite als Software Development Intern bei CWI Software mit Fokus auf QA, Testautomatisierung und Backend-Entwicklung. Meine Arbeit umfasst automatisierte Tests mit Playwright, Entwicklung mit Spring Boot und PostgreSQL-Datenbanken, immer mit Fokus auf Qualität, Organisation und kontinuierliche Verbesserung.',
